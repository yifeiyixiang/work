...
$(document).ready(function(){   
    ...
    //春节、专升本倒计时
    var starttime = new Date("2023/4/1");
    setInterval(function () {
        ...
        $('.time').html("<h2>专升本倒计时</p>" + "<p><span>" + day + "</span>" + "天</h2>");
        $(".sydate").html(syday);
    ...
    var mess = "<span>奋斗吧, 少年！！</span><span class='B-span2'>记住，一定要相信奇迹！</span><span>相信自己能做到，你就已经成功了一半。</span>";
    $(".Barrage").append(mess);
    ...
    var this_url=window.location.href;
        ...
        wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
            ...
            wx.updateAppMessageShareData({ 
                title: 'Hello, 2023 happy new year', // 分享标题
                desc: '你好, 2023, 新年快乐！ 除夕倒计时, 一大波弹幕正在来袭！！', // 分享描述
